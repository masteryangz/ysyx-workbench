...
#include <reg/reg.h>
//#include <sim_main.h>
#define GET_RF_CASE(i) case i: return top->rootp->Top__DOT__idu__DOT__regfile__DOT__rf_##i;
const char *regs[] = {
...
word_t get_pc() {
  //Log("Getting pc = 0x%08x", top->rootp->Top__DOT__ifu__DOT__pcReg);
  return top->rootp->Top__DOT__ifu__DOT__pcReg;
}
